...
Ee W. Durbin {% include "tw.html", user: "ewdurbin" %},
...
{% include "gh.html", user: "bskinn", repo: "pent" %}{% include "pypi.html", project: "pent" %},
...
[Snappy Code](https://snappycode.org) {% include "yt.html", id: "yFcCuinRVnU", time: "2850" %}.
...
Alyssa Coghlan {% include "tw.html", user: "ncoghlan_dev" %}  
*Sun AM*  
...
[pyproject.toml/src post](/My-How-Why-Pyproject-Src/)
