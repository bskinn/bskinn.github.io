...
Back in [this post](/KSotD-Insert-Equation/), I noted the built-in <kbd>Alt</kbd>-<kbd>N</kbd>-<kbd>E</kbd>-<kbd>I</kbd> and custom-defined <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>Q</kbd> shortcuts to insert an Equation object.  Subsequently, Christopher Sardegna {% include "tw.html", user: "rxcs" %} [pointed out](https://twitter.com/rxcs/status/1030845953610141697) an additional built-in shortcut for inserting equations: <kbd>Alt</kbd>+<kbd>=</kbd>. Works great!
