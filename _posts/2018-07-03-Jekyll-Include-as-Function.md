...
[This post]({{ site.baseurl }}/KSotD-Custom-Word-Shortcuts/) ([source](https://github.com/bskinn/bskinn.github.io/blob/master/_posts/2018-06-27-KSotD-Custom-Word-Shortcuts.md)) illustrates a variety of uses of this `{% raw %}{% include %}{% endraw %}`.
